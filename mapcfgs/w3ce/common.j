...
type attackflags        extends     handle // Added by W3CE
type damagetype         extends     handle
type damagetypes        extends     handle // Added by W3CE
...
type modelhandle                    extends handle
type layerstyleflag                 extends handle
type controlstyleflag               extends handle
type inputmode                      extends handle
type mousestate                     extends handle
type backdropborderflag             extends handle
type framealphamode                 extends handle
...
constant native ConvertInputMode                        takes integer i returns inputmode
constant native ConvertMouseState                       takes integer i returns mousestate
constant native ConvertBackdropBorderFlag               takes integer i returns backdropborderflag
constant native ConvertFrameAlphaMode                   takes integer i returns framealphamode
...
//===================================================
    ...
    constant playerevent        EVENT_PLAYER_MOUSE_DOWN                 = ConvertPlayerEvent(269) // 305 in retail
    constant playerevent        EVENT_PLAYER_MOUSE_UP                   = ConvertPlayerEvent(270) // 306 in retail
    constant playerevent        EVENT_PLAYER_MOUSE_MOVE                 = ConvertPlayerEvent(271) // 307 in retail
    ...
    constant playerunitevent    EVENT_PLAYER_UNIT_SELL                  = ConvertPlayerUnitEvent(272) // 269 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_CHANGE_OWNER          = ConvertPlayerUnitEvent(273) // 270 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SELL_ITEM             = ConvertPlayerUnitEvent(274) // 271 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SPELL_CHANNEL         = ConvertPlayerUnitEvent(275) // 272 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SPELL_CAST            = ConvertPlayerUnitEvent(276) // 273 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SPELL_EFFECT          = ConvertPlayerUnitEvent(277) // 274 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SPELL_FINISH          = ConvertPlayerUnitEvent(278) // 275 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_SPELL_ENDCAST         = ConvertPlayerUnitEvent(279) // 276 in retail
    constant playerunitevent    EVENT_PLAYER_UNIT_PAWN_ITEM             = ConvertPlayerUnitEvent(280) // 277 in retail
    ...
    constant unitevent          EVENT_UNIT_SELL                         = ConvertUnitEvent(289) // 286 in retail
    constant unitevent          EVENT_UNIT_CHANGE_OWNER                 = ConvertUnitEvent(290) // 287 in retail
    constant unitevent          EVENT_UNIT_SELL_ITEM                    = ConvertUnitEvent(291) // 288 in retail
    constant unitevent          EVENT_UNIT_SPELL_CHANNEL                = ConvertUnitEvent(292) // 289 in retail
    constant unitevent          EVENT_UNIT_SPELL_CAST                   = ConvertUnitEvent(293) // 290 in retail
    constant unitevent          EVENT_UNIT_SPELL_EFFECT                 = ConvertUnitEvent(294) // 291 in retail
    constant unitevent          EVENT_UNIT_SPELL_FINISH                 = ConvertUnitEvent(295) // 292 in retail
    constant unitevent          EVENT_UNIT_SPELL_ENDCAST                = ConvertUnitEvent(296) // 293 in retail
    constant unitevent          EVENT_UNIT_PAWN_ITEM                    = ConvertUnitEvent(297) // 294 in retail
...
//===================================================
    ...
    constant abilityintegerfield ABILITY_IF_ALLOWED_TARGETS                 = ConvertAbilityIntegerField('atar')
    ...
    constant abilityrealfield ABILITY_RF_CAST_POINT                         = ConvertAbilityRealField('ucpt')
    constant abilityrealfield ABILITY_RF_CAST_BACK_SWING                    = ConvertAbilityRealField('ucbs')
    constant abilityrealfield ABILITY_RF_CASTING_TIME                       = ConvertAbilityRealField('acas')
    ...
    constant abilityintegerlevelfield ABILITY_ILF_BUFFID                            = ConvertAbilityIntegerLevelField('abuf')
    constant abilityintegerlevelfield ABILITY_ILF_EFFECTID                          = ConvertAbilityIntegerLevelField('aeff')
    constant abilityintegerlevelfield ABILITY_ILF_ALLOWED_TARGETS                   = ConvertAbilityIntegerLevelField('atar')
    ...
    constant abilityintegerlevelfield ABILITY_ILF_SPAWN_UNIT_ID_NSY2             = ConvertAbilityIntegerLevelField('Nsy2')
    constant abilityintegerlevelfield ABILITY_ILF_REQUIRED_UNIT_TYPE             = ConvertAbilityIntegerLevelField('tpi1')
    constant abilityintegerlevelfield ABILITY_ILF_CONVERTED_UNIT_TYPE            = ConvertAbilityIntegerLevelField('tpi2')
    constant abilityintegerlevelfield ABILITY_ILF_PARTNER_UNIT_TYPE              = ConvertAbilityIntegerLevelField('coa1')
    constant abilityintegerlevelfield ABILITY_ILF_PARTNER_UNIT_TYPE_ONE          = ConvertAbilityIntegerLevelField('dcp1')
    constant abilityintegerlevelfield ABILITY_ILF_PARTNER_UNIT_TYPE_TWO          = ConvertAbilityIntegerLevelField('dcp2')
    constant abilityintegerlevelfield ABILITY_ILF_UNIT_TYPE_ONE                  = ConvertAbilityIntegerLevelField('Rai3')
    constant abilityintegerlevelfield ABILITY_ILF_UNIT_TYPE_TWO                  = ConvertAbilityIntegerLevelField('Rai4')
    constant abilityintegerlevelfield ABILITY_ILF_UNIT_TYPE_SOD2                 = ConvertAbilityIntegerLevelField('Sod2')
    constant abilityintegerlevelfield ABILITY_ILF_SUMMON_1_UNIT_TYPE             = ConvertAbilityIntegerLevelField('Ist1')
    constant abilityintegerlevelfield ABILITY_ILF_SUMMON_2_UNIT_TYPE             = ConvertAbilityIntegerLevelField('Ist2')
    constant abilityintegerlevelfield ABILITY_ILF_RACE_TO_CONVERT                = ConvertAbilityIntegerLevelField('Ndc1')
    constant abilityintegerlevelfield ABILITY_ILF_NORMAL_FORM_UNIT_EME1          = ConvertAbilityIntegerLevelField('Eme1')
    constant abilityintegerlevelfield ABILITY_ILF_NORMAL_FORM_UNIT_MIL1          = ConvertAbilityIntegerLevelField('Mil1')
    constant abilityintegerlevelfield ABILITY_ILF_ALTERNATE_FORM_UNIT_MIL2       = ConvertAbilityIntegerLevelField('Mil2')

    constant abilityintegerlevelarrayfield ABILITY_ILAF_BUFFID              = ConvertAbilityIntegerLevelArrayField('abuf')
    ...
    constant itemintegerfield ITEM_IF_OLD_LEVEL             = ConvertItemIntegerField('ilvo')
    constant itemintegerfield ITEM_IF_STOCK_MAX             = ConvertItemIntegerField('isto')
    constant itemintegerfield ITEM_IF_STOCK_REG             = ConvertItemIntegerField('istr')
    constant itemintegerfield ITEM_IF_STOCK_DELAY           = ConvertItemIntegerField('isst')
    ...
    constant unitintegerfield UNIT_IF_GOLD_REPAIR_COST                      = ConvertUnitIntegerField('ugor')
    constant unitintegerfield UNIT_IF_LUMBER_REPAIR_COST                    = ConvertUnitIntegerField('ulur')
    constant unitintegerfield UNIT_IF_CARGO_SIZE                            = ConvertUnitIntegerField('ucar')
    constant unitintegerfield UNIT_IF_REPULSE_GROUP                         = ConvertUnitIntegerField('urpg')
    constant unitintegerfield UNIT_IF_REPULSE_PARAM                         = ConvertUnitIntegerField('urpp')
    constant unitintegerfield UNIT_IF_REPULSE_PRIO                          = ConvertUnitIntegerField('urpr')
    constant unitintegerfield UNIT_IF_BUILD_TIME                            = ConvertUnitIntegerField('ubld')
    constant unitintegerfield UNIT_IF_STOCK_MAX                             = ConvertUnitIntegerField('usma')
    constant unitintegerfield UNIT_IF_POINT_VALUE                           = ConvertUnitIntegerField('upoi')
    constant unitintegerfield UNIT_IF_RACE                                  = ConvertUnitIntegerField('urac')
    constant unitintegerfield UNIT_IF_HIT_POINTS_BASE                       = ConvertUnitIntegerField('uhpm')
    constant unitintegerfield UNIT_IF_MANA_BASE                             = ConvertUnitIntegerField('umpm')
    constant unitintegerfield UNIT_IF_MANA_START                            = ConvertUnitIntegerField('umpi')
    constant unitintegerfield UNIT_IF_REPAIR_TIME                           = ConvertUnitIntegerField('urtm')
    constant unitintegerfield UNIT_IF_DEFENSE_UPGRADE_BONUS                 = ConvertUnitIntegerField('udup')
    ...
    constant unitrealfield UNIT_RF_SPEED_MAX                                    = ConvertUnitRealField('umas')
    constant unitrealfield UNIT_RF_SPEED_MIN                                    = ConvertUnitRealField('umis')
    ...
    constant unitbooleanfield UNIT_BF_REPULSE                               = ConvertUnitBooleanField('urpo')
    constant unitbooleanfield UNIT_BF_CAN_FLEE                              = ConvertUnitBooleanField('ufle')
    constant unitbooleanfield UNIT_BF_CAN_SLEEP                             = ConvertUnitBooleanField('usle')
    ...
    constant unitweaponrealfield UNIT_WEAPON_RF_MOTION_BUFFER                       = ConvertUnitWeaponRealField('urb1')
...
// =========================
// Ability API
native CeGetAbilityLevel                        takes ability whichAbility returns integer

// Damage API
native CeGetEventAttackFlags                    takes nothing returns attackflags
native CeGetEventDamageTypes                    takes nothing returns damagetypes
native CeSetEventDamageTypes                    takes damagetypes damageTypes returns boolean
native CeGetEventIsRanged                       takes nothing returns boolean
...
// Unit Weapon 
// WeaponIndex 1 & 2
native CeGetUnitWeaponBooleanField                takes unit whichUnit, unitweaponbooleanfield whichField, integer index returns boolean
native CeGetUnitWeaponIntegerField                takes unit whichUnit, unitweaponintegerfield whichField, integer index returns integer
native CeGetUnitWeaponRealField                   takes unit whichUnit, unitweaponrealfield whichField, integer index returns real
native CeGetUnitWeaponStringField                 takes unit whichUnit, unitweaponstringfield whichField, integer index returns string
native CeSetUnitWeaponBooleanField                takes unit whichUnit, unitweaponbooleanfield whichField, integer index, boolean value returns boolean
native CeSetUnitWeaponIntegerField                takes unit whichUnit, unitweaponintegerfield whichField, integer index, integer value returns boolean
native CeSetUnitWeaponRealField                   takes unit whichUnit, unitweaponrealfield whichField, integer index, real value returns boolean
native CeSetUnitWeaponStringField                 takes unit whichUnit, unitweaponstringfield whichField, integer index, string value returns boolean

// Level starts with 1
native CeGetAbilityBooleanLevelField              takes ability whichAbility, abilitybooleanlevelfield whichField, integer level returns boolean
native CeGetAbilityIntegerLevelField              takes ability whichAbility, abilityintegerlevelfield whichField, integer level returns integer
native CeGetAbilityRealLevelField                 takes ability whichAbility, abilityreallevelfield whichField, integer level returns real
native CeGetAbilityStringLevelField               takes ability whichAbility, abilitystringlevelfield whichField, integer level returns string
native CeGetAbilityIntegerLevelArrayField         takes ability whichAbility, abilityintegerlevelarrayfield whichField, integer level, integer index returns integer
native CeSetAbilityBooleanLevelField              takes ability whichAbility, abilitybooleanlevelfield whichField, integer level, boolean value returns boolean
native CeSetAbilityIntegerLevelField              takes ability whichAbility, abilityintegerlevelfield whichField, integer level, integer value returns boolean
native CeSetAbilityRealLevelField                 takes ability whichAbility, abilityreallevelfield whichField, integer level, real value returns boolean
native CeSetAbilityStringLevelField               takes ability whichAbility, abilitystringlevelfield whichField, integer level, string value returns boolean
native CeSetAbilityIntegerLevelArrayField         takes ability whichAbility, abilityintegerlevelarrayfield whichField, integer level, integer index, integer value returns boolean
